...
<body class="theme-red">
                        ...
                        <div class="header">
                            <?php 
								if(isset($_POST['cari'])){
									$dari = $_POST['dari'];
									$sampai = $_POST['sampai'];
									$sqlkat = "SELECT ikan_umum.*, tahun.* 
											   FROM ikan_umum, tahun WHERE 
											   ikan_umum.id_tahun=tahun.id_tahun AND 
											   tahun.tahun='$sampai'";
									$querykat = mysqli_query($koneksidb,$sqlkat);
									$tahun = mysqli_fetch_array($querykat);
							?>
							<h2>
                                Data Jumlah Produksi dan Nilai Produksi Perikanan Umum di Kabupaten Tasikmalaya Tahun <?php echo $tahun['tahun']; ?>
                            </h2>
							<?php }else{ ?>
							<h2>
                                Data Jumlah Produksi dan Nilai Produksi Perikanan Umum di Kabupaten Tasikmalaya
                            </h2>
							<?php }?>
                        </div>
                        <div class="body">
								...
								<table class="display table table-striped table-bordered table-hover" width="100%" id="example-table" cellspacing="0">
									<thead>
										<tr>
											...
											<th class="text-center">Produksi Waduk (ton)</th>
											<th class="text-center">Nilai Produksi Waduk (Rp)</th>
											<th class="text-center">Produksi Sungai (ton)</th>
											<th class="text-center">Nilai Produksi Sungai (Rp)</th>
											<th class="text-center">Produksi Danau (ton)</th>
											<th class="text-center">Nilai Produksi Danau (Rp)</th>
											<th class="text-center">Produksi Rawa (ton)</th>
											<th class="text-center">Nilai Produksi Rawa (Rp)</th>
											<th class="text-center">Produksi Genangan Air (ton)</th>
											<th class="text-center">Nilai Produksi Genangan Air (Rp)</th>
									...
									<tbody>
										<?php 
											...
											if(isset($_POST['cari'])){
												$dari = $_POST['dari'];
												$sampai = $_POST['sampai'];
												$sqlthn = "SELECT ikan_umum.*, kecamatan.*, tahun.* FROM ikan_umum, kecamatan, tahun WHERE 
														   ikan_umum.id_kecamatan=kecamatan.id_kecamatan AND
														   ikan_umum.id_tahun=tahun.id_tahun AND 
										...
										<tr>
											...
											<td class="text-center">
												<button type="button" class="btn btn-warning btn-circle waves-effect waves-circle waves-float" 
														data-toggle="modal" data-target="#editModal<?php echo htmlentities($result['id_ikan_umum']);?>">
													<i class="material-icons">mode_edit</i>
												</button>&nbsp;&nbsp;
												<!-- Large Size -->
												<div class="modal fade" id="editModal<?php echo htmlentities($result['id_ikan_umum']);?>" tabindex="-1" role="dialog">
													<div class="modal-dialog modal-lg" role="document">
														<div class="modal-content">
															<div class="modal-header">
																<h4 class="modal-title" id="editModalLabel">Form Edit Data Perikanan Perairan Umum</h4>
															</div>
															<div class="modal-body">
																<form method="POST" action="module=perikanan-umum-edit">
																	<div class="col-sm-6">
																		<div class="form-group">
																	...
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label class="form-control-label" style="float:left;"><b>Produksi Waduk (ton)</b></label>
																			<div class="form-line">
																				<input type="hidden" name="id" value="<?php echo htmlentities($result['id_ikan_umum']);?>">
																	...
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label class="form-control-label" style="float:left;"><b>Nilai Produksi Waduk (Rp)</b></label>
																			<div class="form-line">
																	...
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label class="form-control-label" style="float:left;"><b>Produksi Sungai (ton)</b></label>
																			<div class="form-line">
																	...
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label class="form-control-label" style="float:left;"><b>Nilai Produksi Sungai (Rp)</b></label>
																			<div class="form-line">
																	...
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label class="form-control-label" style="float:left;"><b>Produksi Danau (ton)</b></label>
																			<div class="form-line">
																	...
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label class="form-control-label" style="float:left;"><b>Nilai Produksi Danau (Rp)</b></label>
																			<div class="form-line">
																	...
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label class="form-control-label" style="float:left;"><b>Produksi Rawa (ton)</b></label>
																			<div class="form-line">
																	...
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label class="form-control-label" style="float:left;"><b>Nilai Produksi Rawa (Rp)</b></label>
																			<div class="form-line">
																	...
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label class="form-control-label" style="float:left;"><b>Produksi Genangan Air (ton)</b></label>
																			<div class="form-line">
																	...
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label class="form-control-label" style="float:left;"><b>Nilai Produksi Genangan Air (Rp)</b></label>
																			<div class="form-line">
												...
												<button type="button" class="btn btn-danger btn-circle waves-effect waves-circle waves-float"
														onclick="Swal.fire({
															...
															confirmButtonText: 'Ya Hapus',
																...
																window.location = 'ikan-umum-del.php?id=<?php echo htmlentities($result['id_ikan_umum']);?>';
																}
															})">
	...
	<!-- Form Edit -->
	<?php include ('ikan-umum-input.php'); ?>
	<!-- #END# Form Edit -->
	<script type="text/javascript">
        function deleteall() {
			...
			confirmButtonText: 'Ya Hapus',
				...
				if (result.isConfirmed) {
				window.location = 'ikan-umum-delall.php';
				}
			})
		}
	</script>
