...
<body class="theme-red">
                        ...
                        <div class="header">
                            <?php 
								if(isset($_POST['cari'])){
									$dari = $_POST['dari'];
									$sampai = $_POST['sampai'];
									$sqlkat = "SELECT ikan_budidaya.*, tahun.* 
											   FROM ikan_budidaya, tahun WHERE 
											   ikan_budidaya.id_tahun=tahun.id_tahun AND 
											   tahun.tahun='$sampai'";
									$querykat = mysqli_query($koneksidb,$sqlkat);
									$tahun = mysqli_fetch_array($querykat);
							?>
							<h2>
                                Data Jumlah Produksi dan Nilai Produksi Perikanan Budidaya di Kabupaten Tasikmalaya Tahun <?php echo $tahun['tahun']; ?>
                            </h2>
							<?php }else{ ?>
							<h2>
                                Data Jumlah Produksi dan Nilai Produksi Perikanan Budidaya di Kabupaten Tasikmalaya
                            </h2>
							<?php }?>
                        </div>
                        <div class="body">
								...
								<table class="display table table-striped table-bordered table-hover" width="100%" id="example-table" cellspacing="0">
									<thead>
										<tr>
											...
											<th class="text-center">Produksi Gurame (ton)</th>
											<th class="text-center">Nilai Produksi Gurame (Rp)</th>
											<th class="text-center">Produksi Lele (ton)</th>
											<th class="text-center">Nilai Produksi Lele (Rp)</th>
											<th class="text-center">Produksi Nila (ton)</th>
											<th class="text-center">Nilai Produksi Nila (Rp)</th>
											<th class="text-center">Produksi Ikan Mas (ton)</th>
											<th class="text-center">Nilai Produksi Ikan Mas (Rp)</th>
											<th class="text-center">Produksi Udang (ton)</th>
											<th class="text-center">Nilai Produksi Udang (Rp)</th>
									...
									<tbody>
										<?php 
											...
											if(isset($_POST['cari'])){
												$dari = $_POST['dari'];
												$sampai = $_POST['sampai'];
												$sqlthn = "SELECT ikan_budidaya.*, kecamatan.*, tahun.* FROM ikan_budidaya, kecamatan, tahun WHERE 
														   ikan_budidaya.id_kecamatan=kecamatan.id_kecamatan AND
														   ikan_budidaya.id_tahun=tahun.id_tahun AND 
										...
										<tr>
											...
											<td class="text-center">
												<button type="button" class="btn btn-warning btn-circle waves-effect waves-circle waves-float" 
														data-toggle="modal" data-target="#editModal<?php echo htmlentities($result['id_ikan_budidaya']);?>">
													<i class="material-icons">mode_edit</i>
												</button>&nbsp;&nbsp;
												<!-- Large Size -->
												<div class="modal fade" id="editModal<?php echo htmlentities($result['id_ikan_budidaya']);?>" tabindex="-1" role="dialog">
													<div class="modal-dialog modal-lg" role="document">
														<div class="modal-content">
															<div class="modal-header">
																<h4 class="modal-title" id="editModalLabel">Form Edit Data Perikanan budidaya</h4>
															</div>
															<div class="modal-body">
																<form method="POST" action="module=perikanan-budidaya-edit">
																	<div class="col-sm-6">
																		<div class="form-group">
																	...
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label class="form-control-label" style="float:left;"><b>Produksi Gurame (ton)</b></label>
																			<div class="form-line">
																				<input type="hidden" name="id" value="<?php echo htmlentities($result['id_ikan_budidaya']);?>">
																	...
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label class="form-control-label" style="float:left;"><b>Nilai Produksi Gurame (Rp)</b></label>
																			<div class="form-line">
																	...
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label class="form-control-label" style="float:left;"><b>Produksi Lele (ton)</b></label>
																			<div class="form-line">
																	...
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label class="form-control-label" style="float:left;"><b>Nilai Produksi Lele (Rp)</b></label>
																			<div class="form-line">
																	...
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label class="form-control-label" style="float:left;"><b>Produksi Nila (ton)</b></label>
																			<div class="form-line">
																	...
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label class="form-control-label" style="float:left;"><b>Nilai Produksi Nila (Rp)</b></label>
																			<div class="form-line">
																	...
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label class="form-control-label" style="float:left;"><b>Produksi Ikan Mas (ton)</b></label>
																			<div class="form-line">
																	...
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label class="form-control-label" style="float:left;"><b>Nilai Produksi Ikan Mas (Rp)</b></label>
																			<div class="form-line">
												...
												<button type="button" class="btn btn-danger btn-circle waves-effect waves-circle waves-float"
														onclick="Swal.fire({
															...
															confirmButtonText: 'Ya Hapus',
																...
																window.location = 'ikan-budidaya-del.php?id=<?php echo htmlentities($result['id_ikan_budidaya']);?>';
																}
															})">
	...
	<!-- Form Edit -->
	<?php include ('ikan-budidaya-input.php'); ?>
	<!-- #END# Form Edit -->
	<script type="text/javascript">
        function deleteall() {
			...
			confirmButtonText: 'Ya Hapus',
				...
				if (result.isConfirmed) {
				window.location = 'ikan-budidaya-delall.php';
				}
			})
		}
	</script>
