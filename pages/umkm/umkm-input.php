	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="inputModalLabel">Form Input Data UMKM</h4>
			</div>
			<div class="modal-body">
				<form method="POST" action="module=umkm-input">
					<div class="col-sm-6">
					...
					<div class="col-sm-12">
						<div class="form-group">
							<label class="form-control-label"><b>Jumlah UMKM</b></label>
							<div class="form-line">
								<input type="number" name="umkm" class="form-control" min=0 value="0">
							</div>
						</div>
					</div>
			</div>
