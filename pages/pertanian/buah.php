                        ...
                        <div class="header">
                            <?php 
								if(isset($_POST['cari'])){
									$dari = $_POST['dari'];
									$sampai = $_POST['sampai'];
									$sqlkat = "SELECT buah.*, jenis_buah.*, tahun.* 
											   FROM buah, jenis_buah, tahun WHERE 
											   buah.id_jenis_buah=jenis_buah.id_jenis_buah AND 
											   buah.id_tahun=tahun.id_tahun AND 
											   tahun.tahun='$sampai' AND jenis_buah.jenis_buah='$dari'";
									$querykat = mysqli_query($koneksidb,$sqlkat);
									$tahun = mysqli_fetch_array($querykat);
							?>
							<h2>
                                Data Jumlah Panen dan Produksi Buah <?php echo $tahun['jenis_buah']; ?> di Kabupaten Tasikmalaya Tahun <?php echo $tahun['tahun']; ?>
                            </h2>
							<?php }else{ ?>
							<h2>
                                Data Jumlah Panen dan Produksi Buah-buahan di Kabupaten Tasikmalaya
                            </h2>
							<?php }?>
                        </div>
                        <div class="body">
										...
										<div class="col-md-2">
											<div class="form-group">
												<select class="form-control dari" name="dari" required>
													<option></option>
													<?php
														$mySql = "SELECT * FROM jenis_buah ORDER BY jenis_buah";
									...
									<tbody>
										<?php 
											...
											if(isset($_POST['cari'])){
												$dari = $_POST['dari'];
												$sampai = $_POST['sampai'];
												$sqlthn = "SELECT buah.*, jenis_buah.*, kecamatan.*, tahun.* FROM buah, jenis_buah, kecamatan, tahun WHERE 
														   buah.id_kecamatan=kecamatan.id_kecamatan AND 
														   buah.id_jenis_buah=jenis_buah.id_jenis_buah AND 
														   buah.id_tahun=tahun.id_tahun AND 
														   tahun.tahun='$sampai' AND jenis_buah.id_jenis_buah='$dari' ORDER BY kecamatan.kecamatan ASC";
											}else{
											$sqlthn = "SELECT buah.*, jenis_buah.*, kecamatan.*, tahun.* FROM buah, jenis_buah, kecamatan, tahun WHERE 
													   buah.id_kecamatan=kecamatan.id_kecamatan AND 
													   buah.id_jenis_buah=jenis_buah.id_jenis_buah AND 
										...
										<tr>
											...
											<td class="text-center">
												<button type="button" class="btn btn-warning btn-circle waves-effect waves-circle waves-float" 
														data-toggle="modal" data-target="#editModal<?php echo htmlentities($result['id_buah']);?>">
													<i class="material-icons">mode_edit</i>
												</button>&nbsp;&nbsp;
												<!-- Large Size -->
												<div class="modal fade" id="editModal<?php echo htmlentities($result['id_buah']);?>" tabindex="-1" role="dialog">
													<div class="modal-dialog modal-lg" role="document">
														<div class="modal-content">
															<div class="modal-header">
																<h4 class="modal-title" id="editModalLabel">Form Edit Data buah <?php echo $result['jenis_buah']; ?></h4>
															</div>
															<div class="modal-body">
																<form method="POST" action="module=buah-edit">
																	<div class="col-sm-4">
																		<div class="form-group">
																			<label class="form-control-label" style="float:left;"><b>Jenis buah</b><span style="color:red">*</span></label>
																			<div style="text-align:left;">
																				<select class="form-control jenis_buah" name="id_jenis_buah" style="width:100%;" required>
																					<option value="<?php echo htmlentities($result['id_jenis_buah']);?>"><?php echo htmlentities($result['jenis_buah']);?></option>
																					<?php
																						$mySql = "SELECT * FROM jenis_buah ORDER BY jenis_buah";
																						$myQry = mysqli_query($koneksidb, $mySql);
																						while ($myData = mysqli_fetch_array($myQry)) {
																	...
																	<div class="col-sm-6">
																		<div class="form-group">
																			...
																			<div class="form-line">
																				<input type="hidden" name="id" value="<?php echo htmlentities($result['id_buah']);?>">
												...
												<button type="button" class="btn btn-danger btn-circle waves-effect waves-circle waves-float"
														onclick="Swal.fire({
															...
															confirmButtonText: 'Ya Hapus',
																...
																window.location = 'buah-del.php?id=<?php echo htmlentities($result['id_buah']);?>';
																}
															})">
	...
	<script type="text/javascript">
        function deleteall() {
			...
			confirmButtonText: 'Ya Hapus',
				...
				if (result.isConfirmed) {
				window.location = 'buah-delall.php';
				}
			})
		}
	</script>
