	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="inputModalLabel">Form Input Data Pasar Tradisional</h4>
			</div>
			<div class="modal-body">
				<form method="POST" action="module=pasar-tradisional-input">
					<div class="col-sm-6">
					...
					<div class="col-sm-4">
						<div class="form-group">
							<label class="form-control-label"><b>Jumlah Pasar Permanen</b></label>
							<div class="form-line">
								<input type="number" name="permanen" class="form-control" min=0 value="0">
							</div>
						</div>
					</div>
					<div class="col-sm-4">
						<div class="form-group">
							<label class="form-control-label"><b>Jumlah Pasar Semi Permanen</b></label>
							<div class="form-line">
								<input type="number" name="semi" class="form-control" min=0 value="0">
							</div>
						</div>
					</div>
					<div class="col-sm-4">
						<div class="form-group">
							<label class="form-control-label"><b>Jumlah Pasar Tanpa Bangunan</b></label>
							<div class="form-line">
								<input type="number" name="tanpa_bng" class="form-control" min=0 value="0">
							</div>
						</div>
					</div>
			</div>
