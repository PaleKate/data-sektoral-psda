	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="POST" action="module=pasar-modern-input">
					<div class="col-sm-6">
					...
					<div class="col-sm-6">
						<div class="form-group">
							<label class="form-control-label"><b>Jumlah Minimarket</b></label>
							<div class="form-line">
								<input type="number" name="minimarket" class="form-control" min=0 value="0">
							</div>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							<label class="form-control-label"><b>Jumlah Supermarket</b></label>
							<div class="form-line">
								<input type="number" name="supermarket" class="form-control" min=0 value="0">
							</div>
						</div>
					</div>
			</div>
