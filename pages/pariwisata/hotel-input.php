	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="inputModalLabel">Form Input Data Hotel dan Akomodasi Lainnya</h4>
			</div>
			<div class="modal-body">
				<form method="POST" action="module=hotel-input">
					<div class="col-sm-6">
					...
					<div class="col-sm-4">
						<div class="form-group">
							<label class="form-control-label"><b>Jumlah Hotel</b></label>
							<div class="form-line">
								<input type="number" name="hotel" class="form-control" min=0 value="0">
							</div>
						</div>
					</div>
					<div class="col-sm-4">
						<div class="form-group">
							<label class="form-control-label"><b>Jumlah Kamar</b></label>
							<div class="form-line">
								<input type="number" name="kamar" class="form-control" min=0 value="0">
							</div>
						</div>
					</div>
					<div class="col-sm-4">
						<div class="form-group">
							<label class="form-control-label"><b>Jumlah Tempat Tidur</b></label>
							<div class="form-line">
								<input type="number" name="kasur" class="form-control" min=0 value="0">
							</div>
						</div>
					</div>
			</div>
