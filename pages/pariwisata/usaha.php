...
<body class="theme-red">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
							...
							?>
							<h2>
                                Data Jumlah Usaha Jasa Wisata Kabupaten Tasikmalaya Tahun <?php echo $dari; ?> - <?php echo $sampai; ?>
                            </h2>
							<?php }else{ ?>
							<h2>
                                Data Jumlah Usaha Jasa Wisata Kabupaten Tasikmalaya
                            </h2>
							<?php }?>
                        </div>
                        <div class="body">
										...
										<div class="col-md-2">
											<div class="form-group">
												<select class="form-control dari" name="dari" required>
													<option></option>
													<?php
														$mySql = "SELECT usaha_wisata.*, tahun.* FROM usaha_wisata, tahun 
																  WHERE usaha_wisata.id_tahun=tahun.id_tahun 
									...
									<tbody>
										<tr><?php $nomor = 1; ?>
											...
											<?php 
												...
												while ($result = mysqli_fetch_array($querythn)){
											?>
											<td class="text-center"><?php echo htmlentities(number_format($result['biro'], 0, ",", "."));?></td>
												<?php }?>
										</tr>
										<tr>
											<td class="text-center"><?php echo $nomor++;?></td>
											...
											<?php 
												...
												while ($result = mysqli_fetch_array($querythn)){
											?>
											<td class="text-center"><?php echo htmlentities(number_format($result['agen'], 0, ",", "."));?></td>
												<?php }?>
										</tr>
									</tbody>
									<tfoot>
	...
	<!-- Form Edit -->
	<?php include ('usaha-input.php'); ?>
	<!-- Form Edit -->
	<?php include ('usaha-edit.php'); ?>
	<script>
		$('.dari').select2({
