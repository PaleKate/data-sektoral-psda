...
<body class="theme-red">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
							...
							?>
							<h2>
                                Data Jumlah Organisasi Pemuda di Kabupaten Tasikmalaya Tahun <?php echo $dari; ?> - <?php echo $sampai; ?>
                            </h2>
							<?php }else{ ?>
							<h2>
                                Data Jumlah Organisasi Pemuda di Kabupaten Tasikmalaya
                            </h2>
							<?php }?>
                        </div>
                        <div class="body">
										...
										<div class="col-md-2">
											<div class="form-group">
												<select class="form-control dari" name="dari" required>
													<option></option>
													<?php
														$mySql = "SELECT organisasi.*, tahun.* FROM organisasi, tahun 
																  WHERE organisasi.id_tahun=tahun.id_tahun 
									...
									<tbody>
										<tr><?php $nomor = 1; ?>
											...
											<?php 
												...
												while ($result = mysqli_fetch_array($querythn)){
											?>
											<td class="text-center"><?php echo htmlentities(number_format($result['org_olahraga'], 0, ",", "."));?></td>
												<?php }?>
										</tr>
										<tr>
											<td class="text-center"><?php echo $nomor++;?></td>
											...
											<?php 
												...
												while ($result = mysqli_fetch_array($querythn)){
											?>
											<td class="text-center"><?php echo htmlentities(number_format($result['org_sosial'], 0, ",", "."));?></td>
												<?php }?>
										</tr>
									</tbody>
									<tfoot>
										<tr>
											...
											<?php 
												...
												$querythn = mysqli_query($koneksidb,$sqlthn);
												while ($result = mysqli_fetch_array($querythn)){
													$total = $result['org_olahraga'] + $result['org_sosial'];
											?>
	...
	<!-- Form Edit -->
	<?php include ('organisasi-input.php'); ?>
	<!-- Form Edit -->
	<?php include ('organisasi-edit.php'); ?>
	<script>
		$('.dari').select2({
