	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="inputModalLabel">Form Input Data Calon Tenaga Kerja</h4>
			</div>
			<div class="modal-body">
				<form method="POST" action="module=tenaga-kerja-blk-input">
					<div class="col-sm-6">
					...
					<div class="col-sm-6">
						<div class="form-group">
							<label class="form-control-label"><b>Jumlah Calon Tenaga Kerja Laki-laki</b></label>
							<div class="form-line">
								<input type="number" name="tk_laki" class="form-control" min=0 value="0">
							</div>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							<label class="form-control-label"><b>Jumlah Calon Tenaga Kerja Perempuan</b></label>
							<div class="form-line">
								<input type="number" name="tk_perempuan" class="form-control" min=0 value="0">
							</div>
						</div>
					</div>
			</div>
