	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="inputModalLabel">Form Input Data Telur Unggas</h4>
			</div>
			<div class="modal-body">
				<form method="POST" action="module=telur-input">
					<div class="col-sm-6">
					...
					<div class="col-sm-4">
						<div class="form-group">
							<label class="form-control-label" style="float:left;"><b>Ayam Petelur (ton)</b></label>
							<div class="form-line">
